...
export const Icons: React.FC<IconsProps> = ({ icon, className }) => {
  ...
  if (icon === "h5p-addbox") {
    return <AddBox className={className} />;
  }
  if (icon === "h5p-addarrow") {
    return <AddArrow className={className} />;
  }
...
export const MapColor: React.FC<IconProps> = ({ className }) => {
  return (
    <svg
      className={className}
...
export const AddBox: React.FC<IconProps> = ({ className }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const AddArrow: React.FC<IconProps> = ({ className }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
